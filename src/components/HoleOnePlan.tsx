    ...
    <div className="mx-auto max-w-7xl">
      <div className="mb-7 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-3 text-lg font-semibold text-[#284536]">Opening Fairway</p>
        </div>
      ...
      <figure className="overflow-hidden rounded-[1.25rem] border border-[#173b2a]/15 bg-[#d9e5bf] shadow-[0_24px_65px_rgba(20,45,32,0.12)] sm:rounded-[1.75rem]">
        <div className="relative aspect-[3/2] w-full">
          ...
          >
            ...
            <g aria-hidden="true">
              <circle cx="824" cy="648" r="27" fill="#173b2a" opacity="0.92" />
        ...
        <figcaption className="border-t border-[#173b2a]/12 bg-[#fffefa] px-5 py-4 text-xs leading-5 text-[#536058] sm:px-7 sm:text-sm">
      ...
      <div className="mt-7 grid gap-7 rounded-[1.25rem] border border-[#173b2a]/12 bg-white p-5 sm:p-7 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.42fr)] lg:items-center">
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-2" role="group" aria-label="Hole 1 tee color">
            {TEES.map((tee) => (
              <button
                ...
                className={`inline-flex min-h-11 items-center gap-2 rounded-full border px-4 font-navigation text-[11px] font-bold uppercase tracking-[0.1em] transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#285c91] ${tee.name === selectedTee ? "border-[#173b2a] bg-[#e9efe6] text-[#14271d]" : "border-[#173b2a]/15 bg-white text-[#536058] hover:border-[#173b2a]/50"}`}
              >
                <span className="h-3.5 w-3.5 rounded-full border border-[#173b2a]/40" style={{ backgroundColor: tee.color }} aria-hidden="true" />
                {tee.name}
              </button>
            ))}
          </div>
        ...
        <div className="border-t border-[#173b2a]/15 pt-5 lg:border-l lg:border-t-0 lg:pl-7 lg:pt-0">
