...
/* Puti ang lahat ng section, kaya hairline rule ang naghahati sa kanila. */
export const SECTION =
  "relative isolate scroll-mt-24 overflow-hidden border-t border-[#173b2a]/10 bg-white py-14 sm:py-16";
