...
- Name: task03-responsive-layouts.spec.ts >> Task 3 · Responsive Layouts >> TC-109 | Home @ Tablet (768×1024)
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  252877 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: Home-Tablet.png

Call log:
  - Expect "toHaveScreenshot(Home-Tablet.png)" with timeout 10000ms
