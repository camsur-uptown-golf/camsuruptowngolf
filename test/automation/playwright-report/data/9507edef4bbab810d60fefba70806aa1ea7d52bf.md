...
- Name: task04-header-mega-nav.spec.ts >> Task 4 · Header & Mega Navigation (desktop) >> Scroll-lock while a mega-menu is open
- Location: tests\task04-header-mega-nav.spec.ts:55:3
